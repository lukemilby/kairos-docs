...
You can read more [here](../sys-extensions).
...
Bundles can carry also binaries that can be overlayed in the rootfs while [building images](/operator-docs/osartifact/).
